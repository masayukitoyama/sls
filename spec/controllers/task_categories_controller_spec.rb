...
RSpec.describe TaskCategoriesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all task_categories as @task_categories" do
      ...
      expect(assigns(:task_categories)).to eq([task_category])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested task_category as @task_category" do
      ...
      expect(assigns(:task_category)).to eq(task_category)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new task_category as @task_category" do
      ...
      expect(assigns(:task_category)).to be_a_new(TaskCategory)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created task_category as @task_category" do
        post :create, {:task_category => valid_attributes}, valid_session
        expect(assigns(:task_category)).to be_a(TaskCategory)
        expect(assigns(:task_category)).to be_persisted
      end

      it "redirects to the created task_category" do
        post :create, {:task_category => valid_attributes}, valid_session
        expect(response).to redirect_to(TaskCategory.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved task_category as @task_category" do
        post :create, {:task_category => invalid_attributes}, valid_session
        expect(assigns(:task_category)).to be_a_new(TaskCategory)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested task_category" do
        task_category = TaskCategory.create! valid_attributes
        put :update, {:id => task_category.to_param, :task_category => new_attributes}, valid_session
      ...
      it "redirects to the task_category" do
        task_category = TaskCategory.create! valid_attributes
        put :update, {:id => task_category.to_param, :task_category => valid_attributes}, valid_session
        expect(response).to redirect_to(task_category)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the task_category as @task_category" do
        task_category = TaskCategory.create! valid_attributes
        put :update, {:id => task_category.to_param, :task_category => invalid_attributes}, valid_session
        expect(assigns(:task_category)).to eq(task_category)
      end
